...
val luckBrew as Brew = Brews.makeBrew("testingbrew", 200, <potion:minecraft:luck>.makePotionEffect(123, 0));
...
Brews.addOutputRestrictedBrewRecipe(luckBrew, [<botania:vial:1>], [<minecraft:cooked_beef>]);
Brews.addStandardBrewRecipe(luckBrew, [<minecraft:nether_wart>, <minecraft:stone>]);
